...
public class 幸运数字 {
    ...
    public static void main(String[] args) {
        System.out.println(printLuckNumber(1));
        System.out.println(printLuckNumber(2));
        System.out.println(printLuckNumber(3));
        System.out.println(printLuckNumber(4));
        System.out.println(printLuckNumber(5));
        System.out.println(printLuckNumber(6));
        System.out.println(printLuckNumber(7));
        System.out.println(printLuckNumber(8));
        System.out.println(printLuckNumber(9));
        System.out.println(printLuckNumber(10));
        System.out.println(printLuckNumber(12));
    }
    ...
    private static String printLuckNumber(int m) {
        ...
        // 求出m-1深度所有节点数
        int preCount = (int) (Math.pow(2, k - 1) - 1);
        // 计算索引
