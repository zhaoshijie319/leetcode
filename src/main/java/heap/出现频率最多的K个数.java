...
public class 出现频率最多的K个数 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> sorted = new 出现频率最多的K个数().topKFrequent(words, 2);
    ...
    public List<String> topKFrequent(String[] words, int k) {
        ...
        Queue<Pair> pq = new PriorityQueue<>((o1, o2) ->
                (o1.freq == o2.freq) ? o2.word.compareTo(o1.word) : Integer.compare(o1.freq, o2.freq));
